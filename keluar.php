...
<html lang="en">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <!-- the modal edit -->
                                       <div class="modal fade" id="edit<?=$idk; ?>" tabindex="-1">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="post" action="function.php">
                                                    <div class="modal-body">
                                                        <input type="text" name="penerima" value="<?= $penerima; ?>" placeholder="Penerima" class="form-control mb-2" required/>
                                                        <br>
                                                        <input type="number" name="qty" value="<?= $qty; ?>" placeholder="Jumlah" class="form-control mb-2" required/>
                                                        <br>
                                        ...
                                        <!-- Modal Delete -->
                                        <div class="modal fade" id="delete<?=$idk;?>" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Vieri 2025</div>
                            <div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <br>
        <input type="number" name="qty" placeholder="Quantity" class="form-control mb-2" required/>
        <br>
        <input type="text" name="penerima" placeholder="penerima" class="form-control mb-2" required/>
        <br>
